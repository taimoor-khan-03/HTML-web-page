...
A simple and beginner-friendly responsive landing page built using HTML, CSS, and JavaScript.
...
## 📸 Preview
![DevX Preview](./html-page.png)

## 🚀 Getting Started
1. Clone the repository
```bash
git clone https://github.com/taimoor-khan-03/HTML-web-page.git
